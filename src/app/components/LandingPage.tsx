...
export default function LandingPage({ navigate }: { navigate: (p: Page) => void }) {
  const features = [
    ...
    { icon: <Bot size={22} />, title: "AI Career Assistant", desc: "Get skill suggestions and personalized learning roadmaps.", color: "blue" },
    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">Connect with students, alumni and industry through your institution.</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            {[
              ...
              <div key={col.head}>
                ...
                {col.links.map((l, index) => <button key={l} className="block text-sm py-1 hover:text-white transition-colors" onClick={() => navigate((["directory", "mentorship", "events", "jobs", "community"] as Page[])[index])}>{l}</button>)}
              </div>
            ))}
          </div>
